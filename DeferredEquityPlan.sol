...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        require(unlock_time <= now, "you're shares have not vested");
        // 2: `distributed_shares` is less than the `total_shares`
        // Your code here!
        require(distributed_shares < total_shares, "No more shares to distrubute");
        ...
        // Your code here!
        distributed_shares = ((now - start_time) / 365 days * annual_distrubution);
